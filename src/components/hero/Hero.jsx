...
const Hero = () => {
  return (
    <>
       <section className="hero-section w-full min-h-[600px] sm:h-[717px] bg-cover bg-center bg-no-repeat">
      <div className="container mx-auto px-4 flex flex-col sm:flex-row justify-center sm:justify-end items-center h-full py-12 sm:py-0">
        <div className="  w-full max-w-[643px]  bg-white/70 p-6 sm:px-[39px] sm:pt-[62px] sm:pb-[37px] mt-8 sm:mt-[153px] text-center  sm:text-left  rounded-md  backdrop-blur-sm shadow-md ">
        <h2 className="text-sm sm:text-base font-semibold tracking-[3px] text-[#333333] mb-1">
    New Arrival
  </h2>
